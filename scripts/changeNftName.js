...
const main = async () => {
    ...
    const pairKeyViewTony = utils.getKeyPairFromPrivateFileSep(
        constants.PATH_TO_PRIVATE_KEYS

    );
    // console.log("pubkey: ", pairKeyViewTony.publicKey)
    ...
    const hash1 = "4c4f72ee06747adc8169b159c30d1acfe4356e7b3dd0b8d06ae5fb1d436d1409" // CSP nft 
    ...
    const hexString = "020261207299a7d59261d28a0780b92f76b5caff3ee2e3f767d7cd832e269c181767" // Vi tony
    ...
    const newName = new CLString("NoNameNo2")
    const tokenId = new CLU64(0);

    let deploy = DeployUtil.makeDeploy(
        new DeployUtil.DeployParams(
            pairKeyViewTony.publicKey,
            "casper-test",
    ...
    deploy = client.signDeploy(deploy, pairKeyViewTony);
