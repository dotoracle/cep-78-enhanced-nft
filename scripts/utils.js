...
export const getAccountInfos = async (client, stateRootHash, accountHash) => {
  const { Account: accountInfo } = await client.nodeClient.getBlockState(
    stateRootHash,
    `account-hash-${accountHash}`,
    []
 ...
 * @return {Array} An array of assymmetric keys.
 */
 export const getKeyPairOfUser = (pathToUser) => {
...
export const privateToPublic = (path) => {
...
export const getKeyPairFromPrivateFile = (pathx) => {
...
export const getKeyPairFromPrivateFileSep = (pathx) => {
