let DeployUtil,CasperClient,RuntimeArgs,CLString,CLPublicKey,CLByteArray,CLKey,CLAccountHash,CLU64,utils,constants,Utils;_8a2‍.w("casper-js-sdk",[["DeployUtil",["DeployUtil"],function(v){DeployUtil=v}],["CasperClient",["CasperClient"],function(v){CasperClient=v}],["RuntimeArgs",["RuntimeArgs"],function(v){RuntimeArgs=v}],["CLString",["CLString"],function(v){CLString=v}],["CLPublicKey",["CLPublicKey"],function(v){CLPublicKey=v}],["CLByteArray",["CLByteArray"],function(v){CLByteArray=v}],["CLKey",["CLKey"],function(v){CLKey=v}],["CLAccountHash",["CLAccountHash"],function(v){CLAccountHash=v}],["CLU64",["CLU64"],function(v){CLU64=v}]]);_8a2‍.w("./utils.js",[["*",null,function(v){utils=v}]]);_8a2‍.w("./constants",[["*",null,function(v){constants=v}]]);_8a2‍.w("./utils2",[["*",null,function(v){Utils=v}]]);// const {
//     DeployUtil,
//     CasperClient,
//     RuntimeArgs,
//     CLString,
...
const main = async () => {
    ...
    _8a2‍.g.console.log("pubkey: ", pairKeyView.publicKey)
    ...
    const hash1 = "d8c1f5c60a84e090e7fc1a9d0675c7e0952ee15320cd5f821c02032912390ea0" // CSP nft 
    ...
    _8a2‍.g.console.log("signed deloy: ", deploy)
    ...
    _8a2‍.g.console.log("stateRootHash :   ", stateRootHash)
};
