...
pub const HASH_KEY_CASPERPUNK_NAME : &str = "csp_contract_package";
pub const ACCESS_KEY_NAME: &str = "csp_contract_package_access";
...
pub const ARG_RECEIPIENT : &str = "recepient";
