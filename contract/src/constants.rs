...
pub const CONTRACT_NAME: &str = "casper_punk_contract";
pub const CONTRACT_NAME_2 : &str = "casper_punk_contract_2";
pub const HASH_KEY_NAME: &str = "nft_contract_package";
pub const HASH_KEY_CASPERPUNK_NAME : &str = "casperpunk_contract_package";
pub const ACCESS_KEY_NAME: &str = "nft_contract_package_access";
pub const ACCESS_KEY_CASPERPUNK_NAME: &str = "casperpunk_contract_package_access";
