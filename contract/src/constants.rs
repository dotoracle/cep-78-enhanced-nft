...
pub const CONTRACT_NAME: &str = "punk_contract";
pub const CONTRACT_NAME_2 : &str = "punk_contract_2";
pub const HASH_KEY_NAME: &str = "punk_contract_package";
pub const HASH_KEY_CASPERPUNK_NAME : &str = "punk_contract_package";
pub const ACCESS_KEY_NAME: &str = "punk_contract_package_access";
pub const ACCESS_KEY_CASPERPUNK_NAME: &str = "punk_contract_package_access";
pub const CONTRACT_VERSION: &str = "contract_version";
pub const CONTRACT_VERSION_2 : &str = "contract_version_2";
pub const CONTRACT_VERSION_3 : &str = "contract_version_3";
